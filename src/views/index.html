<html>
	<head>
		...
		<title>El Aviador | Alex</title>
		<meta name="author" content="Isaac Alejandro Villaseñor Lopez" />
	...
	<body>
		<div class="game-holder" id="gameHolder">
			<div class="header">
				...
				<div class="score" id="score">
					...
					<div class="score__content" id="energy">
						<div class="score__label">Combustible</div>
			...
			<div class="message message--replay" id="replayMessage">Reiniciar</div>
			<div class="message message--instructions" id="instructions">Toma las diguras verdes<span>esquiva las moradas</span></div>
		</div>
	</body>
</html>
